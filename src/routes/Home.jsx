...
const Home = () => {
    ...
    const handleScroll = (section, duration = 500) => {
    ...
    return (
        <div className="bg-blue-900 text-white h-screen flex flex-col">
            ...
            <div className="absolute bottom-[5%] left-[50%] translate-x-[-50%] bg-black p-6 rounded-xl text-white flex items-center justify-center">
                <div className="cursor-pointer" onClick={() => handleScroll(homeRef)}>Home</div>
                <div className="mx-12 cursor-pointer" onClick={() => handleScroll(aboutRef)}>About</div>
                <div className="cursor-pointer" onClick={() => handleScroll(moreRef)}>More</div>
            </div>
        </div>
    );
};
